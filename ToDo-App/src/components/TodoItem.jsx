  ...
  return (
    ...
    >
      ...
      <div className="flex gap-2 pt-4 border-t border-gray-200">
        <button
          className="flex-1 flex items-center justify-center gap-2 bg-blue-500 text-white px-4 py-2.5 rounded-lg hover:bg-blue-600 transform hover:scale-105 font-semibold shadow-md hover:shadow-lg transition-all duration-200"
          onClick={() => onEdit(task)}
        >
